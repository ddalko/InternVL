#!/bin/bash
#SBATCH --job-name=260224_38b_LoRA_sft_stage2_only_full
...
EXP_NAME=260224_38b_LoRA_sft_stage2_only_full
...
srun --ntasks-per-node=1 \
  ...
  bash -c '
    ...
    torchrun \
      ...
      --model_name_or_path "/fsx/VLM/internvl3_5/code/InternVL-debug/internvl_chat_gpt_oss/work_dirs/checkpoint-30000-merged-gemini" \
