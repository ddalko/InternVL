#!/bin/bash
#SBATCH --job-name=260205_sft_stage_2_only
...
EXP_NAME=260205_sft_stage_2_only_full
...
# Checkpoint steps (comma-separated list for specific steps)
CHECKPOINT_STEPS="10000,20000,30000,40000,42000"
