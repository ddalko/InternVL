#!/bin/bash
#SBATCH --job-name=260209_sft_stage_2_only_full_resume
...
RESUME_CHECKPOINT="work_dirs/260209_sft_stage_2_only_full/260209_38b_sft_stage_2_only_full/checkpoint-2000"
